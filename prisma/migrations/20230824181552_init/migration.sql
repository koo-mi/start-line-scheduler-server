...
-- AddForeignKey
ALTER TABLE `Location` ADD CONSTRAINT `Location_user_ProfileId_fkey` FOREIGN KEY (`user_ProfileId`) REFERENCES `User_Profile`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Checklist` ADD CONSTRAINT `Checklist_user_ProfileId_fkey` FOREIGN KEY (`user_ProfileId`) REFERENCES `User_Profile`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Navigation` ADD CONSTRAINT `Navigation_directionId_fkey` FOREIGN KEY (`directionId`) REFERENCES `Direction`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
